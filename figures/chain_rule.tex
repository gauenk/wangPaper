...
\begin{tikzpicture}[baseline=(current bounding box.center),thick,scale=0.8, every node/.style={scale=0.8}]
  \node (A) at (0,1.3) {
    \LARGE{$
      \frac{\partial z^{4}}{\partial w_{1}} =  
      \frac{\partial z^{4}}{\partial z_{2}^{3}}\; \frac{\partial z_{2}^{3}}{\partial z_{3}^{2}}\;\frac{\partial z_{3}^{2}}{\partial w_{1}} 
      + \frac{\partial z^{4}}{\partial z_{2}^{3}}\; \frac{\partial z_{2}^{3}}{\partial z_{2}^{2}}\;\frac{\partial z_{2}^{2}}{\partial w_{1}} 
      + \frac{\partial z^{4}}{\partial z_{2}^{3}}\; \frac{\partial z_{2}^{3}}{\partial z_{1}^{2}}\;\frac{\partial z_{1}^{2}}{\partial w_{1}}
      $}
  };

  \node (B) at (0,0) {
    \LARGE{$
      +\; \frac{\partial z^{4}}{\partial z_{1}^{3}} \;\frac{\partial z_{1}^{3}}{\partial z_{3}^{2}}\;\frac{\partial z_{3}^{2}}{\partial w_{1}} 
      + \frac{\partial z^{4}}{\partial z_{1}^{3}} \;\frac{\partial z_{1}^{3}}{\partial z_{2}^{2}}\;\frac{\partial z_{2}^{2}}{\partial w_{1}} 
      + \frac{\partial z^{4}}{\partial z_{1}^{3}} \;\frac{\partial z_{1}^{3}}{\partial z_{1}^{2}}\;\frac{\partial z_{1}^{2}}{\partial w_{1}}
      $}
  };
